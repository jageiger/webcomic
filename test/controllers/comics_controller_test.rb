...
class ComicsControllerTest < ActionController::TestCase
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post :create, comic: { chapters: @comic.chapters, description: @comic.description, name: @comic.name }
    end
  ...
  test "should update comic" do
    patch :update, id: @comic, comic: { chapters: @comic.chapters, description: @comic.description, name: @comic.name }
    assert_redirected_to comic_path(assigns(:comic))
  end
